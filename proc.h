...
struct context {
  ...
  uint ebx;   // base register, for data storage? I don't understand
  uint ebp;   // base pointer -- point to the base of the stack
...
struct proc {
  ...
  int num_tickets;             // the number of tickets used for lottery scheduling
  ...
  int sleepleft;               // how many more ticks will this process sleep?
